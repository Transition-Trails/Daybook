...
**How to apply:** Treat every provider-bound readable request as closed-world, including mixed negative/affirmative phrasing and text directives embedded in descriptive prose. Only demonstrably pure prohibitions may avoid authorization. Do not classify technical noun phrases such as “print requirements,” quoted decorative adjectives, or narrative verb phrases such as “demanded to be written down” as requested copy; quoted text still requires a text-bearing or directive context. If inherited material exceeds a provider limit, compact source-detail sections but preserve the canonical readable-governance and negative-prompt sections byte-for-byte so boundary validation can remove and assess them correctly.