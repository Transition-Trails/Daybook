...
async function run() {
  ...
  try {
    ...
    console.log("  ✓ ws_component_specs");
    ...
    console.log("  ✓ ws_production_specs");
    ...
    console.log("  ✓ ws_prompt_payloads");
