...
export type PlannerPageOrderItem = {
  /** Stable generated page role, such as "weekly" or "month-calendar". */
  type: string;
  /** Zero-based ordinal inside the page role. */
  index: number;
};
...
export type PlannerStyle = {
  ...
  /**
   * Explicit planner page order. Missing or stale entries are reconciled
   * against the pages generated by setup so older templates remain valid.
   */
