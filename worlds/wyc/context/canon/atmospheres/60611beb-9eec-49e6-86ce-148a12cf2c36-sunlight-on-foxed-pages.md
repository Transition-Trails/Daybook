# Sunlight on Foxed Pages

> Generated from Daybook. Do not edit as source data.

**Canonical ID:** `60611beb-9eec-49e6-86ce-148a12cf2c36`  
**Status:** accepted  
**Category:** atmosphere  
**World:** Wychcombe (`wyc`)
...
Morning light filtered through mullioned windows onto the library table, pooling soft amber across paper ridged with age. The foxed edges of each page seemed to absorb the warmth, darkening their speckled flecks to sepia. Dust danced in slow spirals above the desk, and the shadow of the brass candlestick stretched wide like a memory caught in motion.
