/**
 * migrate-worldsmith-worlds — creates the worldsmith_worlds table.
 *
 * Run: pnpm --filter @workspace/scripts run migrate-worldsmith-worlds
 *
...
async function run() {
  ...
  try {
    ...
    console.log("1. Creating worldsmith_worlds table…");
    await client.query(`
