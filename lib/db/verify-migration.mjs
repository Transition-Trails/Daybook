...
const worldsmithContracts = {
  ...
  worldsmith_production_packages: [
    ...
    "model_version", "effective_size", "quality", "filename", "revision_prompt", "visual_asset_notion_id",
    "notion_upload_id", "provider_request_id", "estimated_cost_usd", "actual_cost_usd",
    "status", "production_art_status", "is_review_candidate", "error", "created_at", "updated_at",
  ],
